...
namespace UIDE.Themes {
	...
	public class ThemeSlateDark:Theme {
		...
		public override void Start() {
			...
			fontUpdateStyleNames.Add(new string[] {"TextEditorLabelBold","Normal"});
			fontUpdateStyleNames.Add(new string[] {"TextSelection","Normal"});
			fontUpdateStyleNames.Add(new string[] {"TextSelectionText","Normal"});
			fontUpdateStyleNames.Add(new string[] {"CursorHoverHighlight","Normal"});
