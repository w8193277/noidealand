...
{
    @MenuItem("Window/6by7/ProGrids (v1.5)")
	...
	function OnGUI()
	{
		...
		if(proGrids)
		{
			...
			if(frackit)
			{
				...
				proGrids.gridSnapSize_Base = EditorGUI.FloatField(Rect(-11,160,50,14), proGrids.gridSnapSize_Base, mySkin.customStyles[0]);
			}
			else
			{
